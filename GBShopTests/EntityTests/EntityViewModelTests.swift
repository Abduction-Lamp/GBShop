...
class EntityViewModelTests: XCTestCase {
    ...
    lazy var product1 = ProductViewModel(bounds: rect, title: "title", category: "category", imageURL: nil, description: "description", price: "100")
    lazy var product2 = ProductViewModel(bounds: rect, title: "title", category: "category", imageURL: nil, description: "description", price: "200")
    
    lazy var review1 = ReviewViewModel(bounds: rect, userLogin: "userLogin", comment: "comment", assessment: 1, date: 10000)
    lazy var review2 = ReviewViewModel(bounds: rect, userLogin: "userLogin", comment: "comment", assessment: 2, date: 10000)
    ...
    func testExampleProductViewModel() throws {
        ...
        let product3 = ProductViewModel(bounds: rect, title: "title", category: "category", imageURL: nil, description: "description", price: "100")
    ...
    func testExampleReviewViewModel() throws {
        ...
        let review3 = ReviewViewModel(bounds: rect, userLogin: "userLogin", comment: "comment", assessment: 1, date: 10000)
